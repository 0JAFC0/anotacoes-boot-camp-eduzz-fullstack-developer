...
- O conteúdo (content) é o que o seu bloco representa, um texto, uma imagem, um vídeo;
 ...
 ![imagem de como funciona](file:///home/ja/Imagens/Screenshot_20220302_021311.png)
...
E uma boa pratica colocar as margins sempre na mesma direçao.
...
este define o peso do texto, existem dois tipos a normal e a bold: onde a bold e a negrito e a normal e a normal.

### text-decoration

underline coloca uma linha abaixo da palavra.

overline coloca uma linha acima da linha.

line-through coloca uma linha ao centro cortando a palavra.
...
vai definir o marcador para um quadrado.

list-style-type: upper-roman

vai definir o marcador para um algorismo romano.

list-style-type: "\1F44D"

vai definir o marcador para um simbolo de joinha.

list-style-type: url("rocket.png")

vai definir o marcador para uma imagem.
